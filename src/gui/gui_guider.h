...
typedef struct
{
    ...
    lv_obj_t* screen_main_btn_speak;
    lv_obj_t* screen_main_animimg_1;
    lv_obj_t* screen_main_btn_speak_label;
    ...
    const char* screen_networking_settings_clicked_wifi_password;
...
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_11);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_12);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_13);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_14);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_15);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_16);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_17);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_18);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_19);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_2);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_3);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_4);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_5);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_6);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_7);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_8);
LV_IMAGE_DECLARE(screen_main_animimg_1noise_check_9);
