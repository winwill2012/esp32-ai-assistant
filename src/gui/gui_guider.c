...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_networking_setting_del = true;
    ui->screen_system_setting_del = true;
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_customer_font_Siyuan_Regular_14, LV_PART_MAIN|LV_STATE_DEFAULT);
}
