...
void setup_scr_home_page(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->home_page_header_state, 129, 7);
    ...
    //Write codes home_page_header_icon
    ui->home_page_header_icon = lv_img_create(ui->home_page_container_top);
    lv_obj_add_flag(ui->home_page_header_icon, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->home_page_header_icon, &_robot_alpha_26x26);
    lv_img_set_pivot(ui->home_page_header_icon, 50,50);
    lv_img_set_angle(ui->home_page_header_icon, 0);
    lv_obj_set_pos(ui->home_page_header_icon, 98, 1);
    lv_obj_set_size(ui->home_page_header_icon, 26, 26);

    //Write style for home_page_header_icon, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->home_page_header_icon, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->home_page_header_icon, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->home_page_header_icon, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->home_page_header_icon, true, LV_PART_MAIN|LV_STATE_DEFAULT);
